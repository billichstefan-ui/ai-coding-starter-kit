...
- Als Stefan möchte ich, dass die Vorschläge auf dem Kontext von KIcasso basieren, damit sie relevant für mein Unternehmen und meine Zielgruppe (Pharma/Healthcare) sind.
...
- [ ] Angenommen ein Firmen-Kontext über KIcasso ist hinterlegt, wenn NORA generiert, dann basieren die Vorschläge auf diesem Kontext (Produkt QualiPilot, Zielgruppe Pharma/Healthcare, Positionierung).
...
src/lib/
  ...
  nora-context.ts          (Fester Firmen-Kontext über KIcasso — die "Wissensbasis")
...
- `src/lib/nora-context.ts` — Firmen-Briefing über KIcasso (Erstentwurf aus PRD + Design-System; von Stefan jederzeit verfeinerbar)
...
| AC5 | Firmen-Kontext in Vorschlägen | ✅ PASS | `nora-context.ts` mit vollständigem KIcasso-Briefing; Unit-Test prüft MOCK_CONTEXT |
